...
export default function BasicModal(props) {
  ...
  async function settechname() {
    console.log("why not1")
      while (apiData_2.id == props)
      {
        console.log("why not")
        setName(apiData_2.teamLeaderName)};
  }
        ...
        <div class="row">
          ...
          {sessionStorage.getItem(
            ...
            <div class="col-6 col-md-2" style={{ marginTop: "10%" }}>
              <Button onClick={handleOpen}>Add Zone</Button>
            </div>
          ) : (
            <>
              <div class="col-6 col-md-2" style={{ marginTop: "10%" }}></div>
            </>
          )}
        </div>
